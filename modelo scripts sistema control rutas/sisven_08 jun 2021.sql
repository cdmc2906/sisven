...
drop table if exists tb_resultado_valida_chip;
...
(
   ...
   er_ruta              varchar(50),
   er_linea_negocio     varchar(5),
   er_ruta_nombre       varchar(250),
   er_semana_visitar    int,
   er_dia_visitar       int,
   er_estado            varchar(50),
   er_fecha_inicio_gestion datetime,
   er_fecha_fin_gestion datetime,
...
(
   ...
   i_semana             varchar(50),
   i_cedula             varchar(20),
   i_listado_operadora  varchar(250),
...
/*==============================================================*/
/* Table: tb_resultado_valida_chip                              */
/*==============================================================*/
create table tb_resultado_valida_chip
(
   rvc_id               int not null,
   rvc_dato_chip        varchar(20),
   rvc_tipo_validacion  varchar(20),
   rvc_subtipo_validacion varchar(20),
   rvc_resultado_validacion varchar(20),
   rvc_ejecutivo        varchar(20),
   rvc_solicitud_fecha  datetime,
   rvc_solicitud_ip     varchar(50),
   rvc_solicitud_dispositivo varchar(250),
   rvc_solicitud_navegador varchar(250),
   rvc_estado_validacion int,
   primary key (rvc_id)
);
...
alter table tb_condicion_promocion add constraint fk_relationship_42 foreign key (pr_id)
      references tb_promocion (pr_id) on delete restrict on update restrict;
...
alter table tb_ejecutivo_ruta add constraint fk_relationship_37 foreign key (e_cod)
      references tb_ejecutivo (e_cod) on delete restrict on update restrict;
