/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     30/06/2017 14:04:09                          */
/*==============================================================*/
...
drop table if exists tb_resumen_rev_historial;
...
/*==============================================================*/
/* Table: tb_resumen_rev_historial                              */
/*==============================================================*/
create table tb_resumen_rev_historial
(
   rrh_id               int not null AUTO_INCREMENT,
   rrh_fecha            date,
   rrh_ejecutivo        varchar(20),
   rrh_nivel_cumplimiento decimal(9,4),
   rrh_visitas_efectuadas int,
   rrh_clientes_ruta    int,
   rrh_cliente_no_visitados int,
   rrh_visitas_fuera_ruta int,
   rrh_cantidad_venta_ruta int,
   rrh_cantidad_venta_fuera_ruta int,
   rrh_clientes_venta   int,
   rrh_total_venta_reportada int,
   rrh_fecha_ingreso    datetime,
   rrh_fecha_modificar  datetime,
   rrh_usr_ingresa      int,
   rrh_usr_modifica     int,
   primary key (rrh_id)
);
