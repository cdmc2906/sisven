...
class CI_DB_active_record extends CI_DB_driver {
    ...
    public function set_insert_batch($key, $value = '', $escape = TRUE) {
        ...
        sort($keys);
        $serverName = "10.130.1.17"; //serverName\instanceName
        $connectionInfo = array("Database" => "tcc_control_ruta", "UID" => "sa", "PWD" => 'GrpMetro"==)');
        $enlace = sqlsrv_connect($serverName, $connectionInfo);
//        $enlace = sqlsrv_connect();
//        $enlace = sqlsrv_connect() mysqli_connect("10.130.1.9", "root", "admin123", "tcc_control_ruta");
