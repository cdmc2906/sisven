...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Mail Notificacion Tececab</title>
        <style type="text/css">
            /* RESET STYLES */
            html {
            ...
            @media only screen and (max-width: 480px){
                ...
                /*td[class="textContent"], td[class="flexibleContainerCell"] {
                     width: 100%;
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" class="textContent">
                                                                                    <h3 style="
                                                                                        ...
                                                                                        margin-top:0;
                                                                                        margin-bottom:3px;
                                                                                        text-align:left;">Estimado(a) <?php echo $model->ejecutivo; ?>,</h3>
                                                                                    <br/>
                                                                                    <div style="
                                                                                         text-align:left;
                                                                                         font-family:Helvetica,Arial,sans-serif;
                                                                                         ...
                                                                                         line-height:135%;
                                                                                         ">
                                                                                        Al analizar el periodo <strong><?php echo $model->periodo; ?></strong>, se han identificado un total de <strong><?php echo $model->cantidadAltas; ?></strong> Altas (Sell-Out) ubicadas en  <?php echo $model->cantidadCiudades; ?> ciudades.
                                                                                        <br/><br/>
                                                                                        En el archivo adjunto a la presente notificacion podra encontrar el detalle de las altas con informacion de la Ciudad, Codigo de cliente, Nombre de cliente, Min, Fecha del Alta y Fecha de Venta.
                                                                                        <br/><br/>
                                                                                        Si tiene alguna duda u observacion puede comunicarse con el Departamento Comercial.
                                                                                        <br/><br/><br/>
                                                                ...
                                                                <tr>
                                                                    <td valign="top" bgcolor="#E1E1E1">
                                                                        <div style="
                                                                             ...
                                                                             text-align:center;
                                                                             line-height:120%;">
                                                                            <div>Copyright &#169; Tececab  2018. Todos&nbsp;los&nbsp;derechos&nbsp;reservados.</div>
                                                                            <div>Forme parte de la cultura ambiental, no imprima este correo a menos que sea estrictamente necesario.</div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
