...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl . "/js/RptVentasConsumosxMes.js"; ?>"></script>
    ...
    <div class="">    
        <div class="form">
            ...
            <div class="row buttons secccionBotones">
                <?php
                echo CHtml::ajaxSubmitButton('Consultar', CHtml::normalizeUrl(array('ReporteVentasConsumosxMes/ConsultarReporte', 'render' => true)), array(
                    'dataType' => 'json',
                    'type' => 'post',
                    'beforeSend' => 'function() {
                            blockUIOpen();
