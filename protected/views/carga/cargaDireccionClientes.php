<?php
$pagina_nombre = 'Carga Direccion Clientes';
...
?>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl . "/js/carga/CargaDireccionClientes.js"; ?>"></script>
<?php
$form = $this->beginWidget('CActiveForm', array(
    ...
    'action' => Yii::app()->request->baseUrl . '/cargaDireccionClientes/SubirArchivo'
        ));
?>
<div class="row">
    <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box-solid">
                        ...
                        SELECT 
                                max(dcli_fecha_ingreso) as fecha 
                            FROM tb_cliente_direccion  
                            ;');
                        $resultado = $command->queryRow();
//                        var_dump($resultado);                        die();
                        $ultimaFecha = $resultado['fecha'] == null ? 'SIN CARGA PREVIA' : DateTime::createFromFormat('Y-m-d H:i:s', $resultado['fecha'])->format(FORMATO_FECHA_LONG_2);
                        ?>
            ...
            <div class="row">
                ...
                echo CHtml::ajaxSubmitButton('Guardar', CHtml::normalizeUrl(
                                array(
                                    'CargaDireccionClientes/GuardarDireccionClientes',
                                    'render' => true)), array(
                    'dataType' => 'json',
                    'type' => 'post',
    ...
    <div class="col-md-8">
        <div class="box box-primary">
            <div id="divTblDireccionClientes" class="_grilla panel panel-shadow" style="background-color: transparent; margin-left: 10px">
                <table id="tblDireccionClientes" class="table table-condensed"></table>
                <div id="pagtblDireccionClientes"> </div>
            </div>
        </div>
    </div>
</div>
