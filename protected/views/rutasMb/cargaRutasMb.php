<?php
$this->breadcrumbs = array('Carga Rutas Mobilvendor',);
...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl . "/js/CargaRutasMb.js"; ?>"></script>
...
//                'enableAjaxValidation' => true,
            ...
            <div class="">
                ...
                <?php
                echo CHtml::ajaxSubmitButton('Guardar', CHtml::normalizeUrl(array('cargarutasmb/guardarRutas', 'render' => true)), array(
                    'dataType' => 'json',
                    'type' => 'post',
                    'beforeSend' => 'function() {
                            blockUIOpen();
