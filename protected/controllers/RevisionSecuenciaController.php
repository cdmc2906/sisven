 ...
 * @author 
 */
class RevisionSecuenciaController extends Controller {
    ...
    public function actionIndex() {
        if (Yii::app()->request->isAjaxRequest) {
            ...
            $model = new RevisionSecuenciaForm();
            $this->render('/proceso/revisionSecuencia', array('model' => $model));
        }
    }
    ...
    public function actionRevisarHistorial() {
        ...
        try {
            ...
            if (Yii::app()->user->id <> intval(USUARIO_INVITADO)) {
                ...
                $model = new RevisionSecuenciaForm();
                if (isset($_POST['RevisionSecuenciaForm'])) {
                    $model->attributes = $_POST['RevisionSecuenciaForm'];
                    $_SESSION['ModelForm'] = $model;
                    Yii::app()->session['ModelForm'] = $model;
//var_dump($model['fechagestion']);die();
