 ...
 * @author
 */
class RptControlVentasMensualForm extends CFormModel {
...
//    public $mes;
    ...
    public function rules() {
        return array(
            array('fechaInicioGestion,fechaFinGestion, ejecutivo,horaInicioGestion,horaFinGestion,precisionVisitas,accionHistorial', 'required'),
