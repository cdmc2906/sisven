 ...
 * @author
 */
class CargaTransferenciasMovistarForm extends CFormModel {
...
//            'fechaConsumo' => 'Fecha Consumo',
            'rutaArchivo' => 'Archivo transferencias Movistar',
            'delimitadorColumnas' => 'Delimitador columnas archivo',
            'fechaUltimaCarga' => 'Fecha ultima carga de transferencias',
        );
    }
