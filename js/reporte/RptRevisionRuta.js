...
function ConfigurarGrid() {
    jQuery("#tblGrid").jqGrid({
        ...
        colModel: [
            {name: 'FECHAREVISION', index: 'FECHAREVISION', width: 70, sortable: false, frozen: true},
            {name: 'FECHARUTA', index: 'FECHARUTA', width: 70, frozen: false, sortable: false, resizable: false, align: "center"},
            {name: 'EJECUTIVO', index: 'EJECUTIVO', width: 120, sortable: false, frozen: true},
            {name: 'CODIGOCLIENTE', index: 'CODIGOCLIENTE', width: 80, sortable: false, frozen: true},
            {name: 'RUTACLIENTE', index: 'RUTACLIENTE', width: 60, sortable: false, frozen: true},
            ...
            {name: 'SECUENCIAVISITA', index: 'SECUENCIAVISITA', width: 50, sortable: false, frozen: true},
